...
/* Date de création :  26/07/2023 16:44:29                      */
/*==============================================================*/
...
alter table salles add constraint FK_Association_10 foreign key (id_soutenance)
      references soutenances (id_soutenance) on delete restrict on update restrict;
